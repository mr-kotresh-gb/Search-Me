...
class SearchEngine:  # Create a search engine object
    ...
    def load_existing_index(self) -> None:  # Load an existing file index into the program
        try:
